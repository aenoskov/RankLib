...
UINT64 indri::infnet::ContextCountAccumulator::getDocOccurrences() const {
  return _docOccurrences;
}

UINT64 indri::infnet::ContextCountAccumulator::getDocCount() const {
  return _docCount;
}

void indri::infnet::ContextCountAccumulator::setDocCount( UINT64 docCount ) {
  _docCount = docCount;
}
...
const indri::infnet::EvaluatorNode::MResults& indri::infnet::ContextCountAccumulator::getResults() {
  ...
  _results[ "docOccurrences" ].push_back( indri::api::ScoredExtentResult( _docOccurrences, 0 ) );
  _results[ "docCount" ].push_back( indri::api::ScoredExtentResult( _docCount, 0 ) );
  return _results;
}
