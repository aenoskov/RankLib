...
static const char* trec_include_tags[] = { "sentence", "text", "hl", "head", "headline", "title", "ttl", "dd", "date", "lp", "leadpara", 0 };
static const char* trec_metadata_tags[] = { "docno", "title", "numsentences", "date", 0 };
