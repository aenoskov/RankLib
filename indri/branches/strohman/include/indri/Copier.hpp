...
namespace indri { 
  namespace lang { 
    ...
    public:
      ...
      virtual void before( class OverlappingExtentPassage* oldNode );
      virtual class Node* after( class OverlappingExtentPassage* oldNode, class OverlappingExtentPassage* newNode );
